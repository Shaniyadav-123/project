    ...
    >
     <Spotlight
      ...
      <div className='p-4 relative z-10 w-full text-center'>
        ...
        <p className="mt-4 font-normal text-base md:text-lg text-nutral-300 max-w-lg mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam facere necessitatibus voluptatibus praesentium, eveniet nam autem blanditiis at sint similique numquam vitae error asperiores </p>
        <div className='mt-4'>
            <Link href={"/courses"}>
